...
with open(os.path.join(current, folder, file_name_1), encoding='utf-8') as file1, open(os.path.join(current, folder, file_name_2), encoding='utf-8') as file2, open(os.path.join(current, folder, file_name_3), encoding='utf-8') as file3, open(os.path.join(current, folder, file_name_4), 'w') as new_file:
    dict_file = {
